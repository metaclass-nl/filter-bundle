<?php
/**
 * Example of filter composition using QueryExpressionGeneratorInterface
 * Copyright (c) MetaClass, Groningen, 2021
 */
...
class EmptyOrNullFilter extends AbstractContextAwareFilter implements QueryExpressionGeneratorInterface
{
